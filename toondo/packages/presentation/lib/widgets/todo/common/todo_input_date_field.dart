...
class DateField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final Color borderColor =
        date != null ? const Color(0xFF78B545) : const Color(0xFFDDDDDD);
    final Color textColor =
        date != null ? const Color(0xFF1C1D1B) : const Color(0x3F1C1D1B);
    final Color iconColor =
        date != null ? const Color(0xFF1C1D1B) : const Color(0xFFDDDDDD);
    ...
    return Expanded(
      child: Column(
        ...
        children: [
          ...
          GestureDetector(
            onTap:
                () => viewModel.selectDate(context, isStartDate: isStartDate),
            child: Container(
              height: 32,
