...
class SpeechBubbleOld extends StatefulWidget {
  ...
  @override
  State<SpeechBubbleOld> createState() => _SpeechBubbleState();
}

class _SpeechBubbleState extends State<SpeechBubbleOld>
...
class SpeechBubbleStyles {
  static const friendly = SpeechBubbleOld(
    message: '',
  ...
  static const excited = SpeechBubbleOld(
    message: '',
  ...
  static const calm = SpeechBubbleOld(
    message: '',
  ...
  static const encouraging = SpeechBubbleOld(
    message: '',
