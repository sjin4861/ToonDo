...
// in data/test/datasources/remote/todo_remote_datasource_test.dart.
...
import 'package:domain/entities/user.dart' as _i8;
import 'package:domain/repositories/auth_repository.dart' as _i11;
...
class MockAuthRepository extends _i1.Mock implements _i11.AuthRepository {
  ...
  @override
  _i9.Future<_i8.User> registerUser(
    String? loginId,
    String? password,
  ) =>
      (super.noSuchMethod(
  ...
  @override
  _i9.Future<bool> checkLoginIdExists(String? loginId) => (super.noSuchMethod(
        Invocation.method(
          #checkLoginIdExists,
          [loginId],
        ),
