import 'package:todo_with_alarm/data/datasources/local/goal_local_datasource.dart';
import 'package:todo_with_alarm/data/datasources/remote/goal_remote_datasource.dart';
...
class GoalRepository {
  ...
  GoalRepository({required this.localDatasource, required this.remoteDatasource});  
